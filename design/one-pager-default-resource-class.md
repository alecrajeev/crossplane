...
1. Change all `Policy` types to `Class` types and include a `classRef` field
   ...
   [`Policy`](https://github.com/alecrajeev/crossplane-runtime/blob/e4d61ee2805af680baf16fc2a1d8f79538d0f9bb/apis/core/v1alpha1/resource.go#L93),
...
1. Alter all claim controllers (which live in provider stacks) to accept a
   ...
   the [shared claim
   reconciler](https://github.com/alecrajeev/crossplane-runtime/blob/e4d61ee2805af680baf16fc2a1d8f79538d0f9bb/pkg/resource/claim_reconciler.go#L281)
...
1. Update [default class controller
   predicates](https://github.com/alecrajeev/crossplane-runtime/blob/e4d61ee2805af680baf16fc2a1d8f79538d0f9bb/pkg/resource/predicates.go#L60)
   to accept resource claims that do not have a `classRef`.
1. Update the [shared default class
   reconciler](https://github.com/alecrajeev/crossplane-runtime/blob/e4d61ee2805af680baf16fc2a1d8f79538d0f9bb/pkg/resource/defaultclass.go#L106)
